    ...
    methods: {
      ...
      saveForm() {
        this.$confirm('是否保存表单信息?', {
          ...
          let rewardRule = this.isEmpty(this.data.reward.toString());
          let requireAmountRule = this.isEmpty(this.data.requireAmount.toString());
