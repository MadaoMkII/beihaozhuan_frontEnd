  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          {prop: 'title', label: '任务名称', width: '350', align: 'left'},
          {prop: 'reward', label: '奖励金币数', width: '120', align: 'left'},
