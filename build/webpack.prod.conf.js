...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    //   },
    //   chunksSortMode: 'dependency',
    //   chunks: ['manifest','vendor','missionAward']
    // }),
    // new HtmlWebpackPlugin({
    //   filename: config.build.missionSignIn,
    //   template: './src/project/missionSignIn/missionSignIn.html',
    //   inject: true,
    //   minify: {
    //     removeComments: true,
    //     collapseWhitespace: true,
    ...
    //   },
    //   chunksSortMode: 'dependency',
    //   chunks: ['manifest','vendor','missionSignIn']
    // }),
